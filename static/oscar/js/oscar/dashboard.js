...
var oscar = (function (o, $) {
    ...
    function onFileChange(evt) {
        ...
        if (numExisting < numMax) {
            ...
            // Add a class or attribute to identify CKEditor-enabled textareas
            $newImg.find('textarea').addClass('ckeditor-enabled');

            // Update attrs on cloned element
            ...
            // Reinitialize CKEditor for the new textarea with the added class
            $('.ckeditor-enabled').each(function () {
                CKEDITOR.replace(this.id, CKEDITOR_CONFIGS.default);
            });
        }
    }
    ...
    o.dashboard = {
        init: function (options) {
            ...
            var defaults = {
                ...
                'tinyConfig': {
                    ...
                    statusbar: false,
                    menubar: false,
                    plugins: "link lists table", // Include the 'table' plugin
                    style_formats: [{
                            title: 'Text',
                            block: 'p'
                        },
                    ...
                    toolbar: "styles | bold italic blockquote | bullist numlist | link | table" // Include 'table' in the toolbar
                }
            };
        ...
        initDatePickers: function (el) {
            if ($.fn.datetimepicker) {
                ...
                $.fn.datetimepicker.Constructor.Default = $.extend({}, $.fn.datetimepicker.Constructor.Default, o.dashboard.options.datetimePickerConfig);
